...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/scripts/DomManipulation.js":[function(require,module,exports) {
...
function () {
  function DomManipulation() {
    ...
    this.secretBtn = document.querySelector(".secretBtn"); // Figure Elements

    this.importantOtter = document.querySelector(".importantOtter");
    this.secretOtter = document.querySelector(".secretOtter"); // Click Decision Elements

    this.decisionEle = document.querySelector(".decision"); // Update the decision initally to our default value
  ...
  _createClass(DomManipulation, [{
    ...
    value: function addEvents() {
      ...
      if (this.importantBtn && this.importantOtter) {
        this.importantBtn.addEventListener("click", function () {
          _this.importantOtter.classList.toggle("visible");
      ...
      if (this.secretBtn && this.secretOtter) {
        this.secretBtn.addEventListener("click", function () {
          _this.secretOtter.classList.toggle("visible");
...
var _DomManipulation = _interopRequireDefault(require("./assets/scripts/DomManipulation.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

document.addEventListener("DOMContentLoaded", function (event) {
  var events = new _DomManipulation.default();
  events.addEvents();
  console.log("Hi");
});
},{"./assets/scripts/DomManipulation.js":"assets/scripts/DomManipulation.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
